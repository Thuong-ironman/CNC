...
int main(int argc, char const *argv[]) {
  ...
  int delay = 0;
  userdata_t ud = {.broker_addr = "localhost", 
  .broker_port = 1883, 
  .topic = "ccnc/test",
  .running = 1,
  .ready_to_exit = 0 //what does . mean?
  };
